...
export const AIF_PERFORMANCE_META = {
  ...
  subtitle: 'Track record across different investment strategies',
  fundLabel: 'Category III AIF (long-only)',
  benchmarkNote: 'Benchmark as defined in scheme documentation.',
}
